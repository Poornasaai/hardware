...
#define TDS_SENSOR_PIN A0       // Pin connected to TDS sensor
#define TEMP_SENSOR_PIN A1      // Pin connected to temperature sensor
#define PH_SENSOR_PIN A2        // Pin connected to soil pH sensor

const char* ssid = "hotspot";
const char* password = "123456789";
const char* apiKey = "BVF6NNX9B7X4T6RO";
